...
test_that("change_snp_numeric_type - results", {
	...
	change_snp_numeric_type(equiv_data$MA, "MA") %>% expect_equivalent(equiv_data$MA)
	change_snp_numeric_type(equiv_data$MA, "DB") %>% expect_equivalent(equiv_data$DB)
	change_snp_numeric_type(equiv_data$MA, "RI") %>% expect_equivalent(equiv_data$RI)
	change_snp_numeric_type(equiv_data$DB, "MA") %>% expect_equivalent(equiv_data$MA)
	change_snp_numeric_type(equiv_data$DB, "DB") %>% expect_equivalent(equiv_data$DB)
	change_snp_numeric_type(equiv_data$DB, "RI") %>% expect_equivalent(equiv_data$RI)
	change_snp_numeric_type(equiv_data$RI, "MA") %>% expect_equivalent(equiv_data$MA)
	change_snp_numeric_type(equiv_data$RI, "DB") %>% expect_equivalent(equiv_data$DB)
	change_snp_numeric_type(equiv_data$RI, "RI") %>% expect_equivalent(equiv_data$RI)
})
